...
\vspace{-1mm}
\begin{itemize}
    \item[--] Secured \textbf{All India Rank 6033} in \textbf{JEE Advanced 2019} among the 2.45 Lakh shortlisted candidates
    \item[--] Secured \textbf{All India Rank 21999} in \textbf{JEE Mains 2019} among the 11.47 Lakh shortlisted candidates
...
{\large \textbf{\begin{tcolorbox}\textsc{Key Projects \& Workshops}\end{tcolorbox}}}
%\vspace{-1mm}
...
\hspace{-1.5mm}\textbf{MNIST Digit Recognizer} $|$ Kaggle Submission
\hfill\hfill\textit{May'21}
\begin{itemize}
\item Implemented a \textbf{Convolutional Neural Network} with \textbf{dropout} and \textbf{batch-normalization layers}
\item Analyzed the performance of the \textbf{classification model} by plotting \textbf{Confusion Matrix}
\item Examined the \textbf{predicted versus true} labels for the \textbf{top 16} wrong predictions
\item Achieved a final accuracy of \textbf{99.08\%} upon submission on kaggle
\end{itemize}
\vspace{-2.5mm}
\vspace{10mm}
\vspace{10mm}
...
\vspace{-2mm}
\hspace{-2mm}\textbf{Secretary Research Wing} $|$ Academics and Career Council IITK
\hfill\hfill\textit{Apr'20 - Mar'21}
\begin{itemize}
\item[--] Approached \textbf{15+ startups} for \textbf{internship positions} in the field of \textbf{E-vehicle R\&D} to help students get internship during lockdown
\item[--] Interacted with \textbf{IITK alumni} and documented their \textbf{research experience} in the form of \textbf{AnC Blogs}
\end{itemize}
\vspace{2mm}
...
\begin{itemize}
    ...
    \item[--] \textbf{Libraries: }Tensorflow, Keras, Numpy, Matplotlib, Pandas, OpenCV, Scipy, Seaborn
    \item[--] \textbf{Software: }Fusion 360, MATLAB, AutoCAD, LAMMPS, OVITO
    \item[--] \textbf{Robotics: }ROS2, Gazebo, Rviz, Nav2
...
\item Worked under \textbf{Photography Club} and \textbf{Film Club} in \textbf{Galaxy'20}, the inter hall Cultural Championship
\item Assisted the Senior Executive in activities pertaining to \textbf{Public Relations} in \textbf{Udghosh'19}, the annual sports fest of IITK\hfill\hfill\textit{Sep'19}
\end{itemize}
\end{document}
